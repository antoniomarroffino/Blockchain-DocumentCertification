                ...
                {isConnected ? (
                    <div className="relative">
                        ...
                        >
                            ...
                            <span className="font-medium text-sm truncate max-w-[10rem] text-white">{fullAddress}</span>
                            <ChevronDownIcon className={`w-5 h-5 text-yellow-400 transform transition-transform duration-300 ${open ? 'rotate-180' : ''}`} />
                        </motion.button>
                                    ...
                                    <div className="p-4 space-y-4 text-white">
                                        <div className="flex items-start space-x-3">
                                            ...
                                            <div className="flex-1">
                                                <p className="text-sm font-semibold break-words">{fullAddress}</p>
