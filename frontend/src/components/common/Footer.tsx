  ...
  return (
      <footer className="bg-neutral-900 text-white border-t border-neutral-700 relative overflow-hidden">
        <div className="absolute inset-0 opacity-10 pointer-events-none">
          <div className="absolute w-72 h-72 bg-yellow-400/20 rounded-full -top-32 -left-32 mix-blend-soft-light animate-float"></div>
          <div className="absolute w-64 h-64 bg-green-400/20 rounded-full top-1/2 right-0 mix-blend-soft-light animate-float-delayed"></div>
        </div>
        ...
        <div className="container mx-auto px-6 py-16 relative">
          <div className="flex flex-col xl:flex-row gap-12 items-start justify-between">
            ...
            >
              <div className="p-4 backdrop-blur-md bg-neutral-800/70 rounded-2xl shadow-lg hover:shadow-yellow-500/30 transition-all duration-300 border border-neutral-700">
                <img
                    src={supsiLogo}
                    alt="SUPSI Logo"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 flex-1 max-w-4xl">
              {developers.map((dev, index) => (
                  ...
                  >
                    <div className="absolute inset-0 bg-gradient-to-r from-yellow-400/5 to-green-400/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"></div>
                        ...
                        <div className="flex space-x-3">
                          {[
                            ...
                            { icon: FaLinkedin, href: dev.linkedin, color: "#0A66C2" },
                              ...
                              >
                                <social.icon className="w-5 h-5 text-neutral-300 hover:text-[var(--hover-color)] transition-colors duration-300" />
                              </motion.a>
                          ))}
                        </div>
                      </div>
